...
export const ScrambleWords = () => {
  ...
  const handlePlayAgain = () => {
    const newArrayOfWords = shuffleArray(GAME_WORDS)
    
    setPoints(0) 
    setErrorCounter(0)
    setGuess('')
    setWords(newArrayOfWords)
    setCurrentWord(newArrayOfWords[0])
    setIsGameOver(false)
    setSkipCounter(0)
    setScrambledWord(scrambleWord(newArrayOfWords[0]))
  };
